#!/usr/bin/perl -w
# count_fastas.pl
######### This script is very slightly modified version of Joseph Fass' Count_fasta.pl (original available at http://wiki.bioinformatics.ucdavis.edu/index.php/Count_fasta.pl ). Only the format of the output has been changed. #########
######### The complete information about the original script is below (lines 5-12) #########
# AUTHOR: Joseph Fass (modified from script by Brad Sickler)
# LAST REVISED: November 2010
#
# http://wiki.bioinformatics.ucdavis.edu/index.php/Count_fasta.pl
